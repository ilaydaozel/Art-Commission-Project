<?php session_start();?>
<html><head>
<title>Watercolor Portrait Order Form
</title>
</head>
...
?>
<form enctype="multipart/form-data" action="watercolor_order.php" method="POST">
<center><h1> Order Your Watercolor Portrait </h1></center> 
