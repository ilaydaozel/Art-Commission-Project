...
If there occur any problems while signing up, you can log in by using email:admin@gmail.com   password:adminilayda
...
6-As I mentioned in number 5, users can upload photos while giving an order. https://artiye-app.herokuapp.com/pencil_form.php , https://artiye-app.herokuapp.com/watercolor_form.php these two links are for uploading a photo.


7-Basic HTML commands are used almost in every page. If I need to give example:
Table-> https://artiye-app.herokuapp.com/price.php (all of the page)
        https://artiye-app.herokuapp.com/pencil_page.php  (at the end)
		https://artiye-app.herokuapp.com/order_info.php (all of the page)
Image-> https://artiye-app.herokuapp.com/gallery.php (all of the page)
		https://artiye-app.herokuapp.com/home.php
		https://artiye-app.herokuapp.com/watercolor_page.php
Lists->https://artiye-app.herokuapp.com/home.php
       https://artiye-app.herokuapp.com/watercolor_page.php
	   https://artiye-app.herokuapp.com/pencil_page.php
	   This is the code:
       <h2>There are just 3 steps:</br>
		<ol>
...
8-9-10- I don't need to explain.
